...
class QuizScreen extends Component {
  ...
  img_ids_segunda_tela = [22, 29, 33, 125, 126, 127, 128, 147, 153, 27, 214, 216, 217, 218, 219, 221, 223, 224, 225, 
                          226, 227, 228, 229, 235, 236, 237, 241, 242, 243, 317, 318, 319, 320, 321, 322, 323, 326, 327, 329];
  ...
  _renderQuizStatus = () => {
      ...
      const texto = (this.state.modalCorrectVisible) ? 'CORRETO' : 'ERRADO';
